...
function clearPreviousState() {
  ...
  sqlQueryContainer.innerHTML = ""; // Clear SQL query
  closeExistingPopup(); // Remove any popup
}
...
function showLoadingIndicator() {
  tableContainer.innerHTML = `<div class="loading-indicator">Loading...</div>`;
}
...
function createPopup(x, y, userQuery, columnName, sqlQuery, options) {
  ...
  popup.style.cssText = `
    position: absolute; top: ${y}px; left: ${x}px; padding: 15px;
  ...
  closeButton.style.cssText = `
    position: absolute; top: 5px; right: 10px; border: none; background: transparent; cursor: pointer;
  `;
